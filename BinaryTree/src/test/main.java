...
//---------------------------
    ...
    Node leftBal(Node p) {
        ...
        switch (p1.bal) {
            case -1:
                /*Cay goc p1 lech trai, nghia la lech cung phia voi p
                   chi can quay phai nut p*/
                p.bal = 0;
                p1.bal = 0;
                return (rotateRight(p));
            case +1:
                /*Cay goc p1 lech phai, nghia la lech khac phia voi p
...
//---------------------------
    ...
    Node rightBal(Node p) {
        ...
        switch (p1.bal) {
            case +1:
                /*Cay goc p1 lech phai, nghia la lech cung phia voi p
	         chi can quay trai nut p*/
                p.bal = 0;
                p1.bal = 0;
                return (rotateLeft(p));
            case -1:
                /*Cay goc p1 lech trai, nghia la lech khac phia voi p
